...
import com.dolcevita.academicinfo.AcademicinfoApplication;
...
public class GoogleCalendarUtils {
    ...
    public static Credential authorize(List<String> scopes) throws Exception {
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
                new InputStreamReader(AcademicinfoApplication.class.getResourceAsStream("/client_secrets.json")));
        ...
        return new AuthorizationCodeInstalledApp(flow, receiver).authorize("671043989823-darfq6lgsrot51mbnl0tom7jh6spf2ag");
    }
